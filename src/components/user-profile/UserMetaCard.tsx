    ...
    <>
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-4 sm:flex-row sm:gap-5">
            <div className="w-16 h-16 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800 shrink-0">
              {avatar ? (
                <Image width={64} height={64} src={avatar} alt="user" />
              ) : (
            ...
            {/* Social Links - commented for later
          ...
          {/* Edit Button - commented for later
          <button
            onClick={openModal}
      ...
      {/* Edit Modal - commented for later
